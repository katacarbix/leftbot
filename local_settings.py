...
ENABLE_TWITTER_POSTING = environ.get('ENABLE_TWITTER_POSTING') or False # Tweet resulting status?
...
ORDER = environ.get('ORDER') or 2 # How closely do you want this to hew to sensical? 2 is low and 4 is high.
